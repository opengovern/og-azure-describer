...
require (
	...
	gitlab.com/keibiengine/steampipe-plugin-azure v0.23.2-0.20230608062902-229ecce71aa9
	gitlab.com/keibiengine/steampipe-plugin-azuread v0.1.1-0.20230608063712-f481fab2c03f
