		...
		Columns: []*plugin.Column{
			{
				...
				Transform: transform.FromField("Description.AdUsers.DisplayName")},
			{
				Name:        "id",
				Type:        proto.ColumnType_STRING,
				Description: "The unique identifier for the user. Should be treated as an opaque identifier.",
				Transform:   transform.FromField("Description.AdUsers.DirectoryObject.ID"),
			},
			{
				...
				Transform: transform.FromField("Description.AdUsers.UserPrincipalName")},
			{
				...
				Transform: transform.FromField("Description.AdUsers.AccountEnabled")},
			{
				...
				Transform: transform.FromField("Description.AdUsers.UserType")},
			{
				Name:        "given_name",
				Type:        proto.ColumnType_STRING,
				Description: "The given name (first name) of the user.",

				Transform: transform.FromField("Description.AdUsers.GivenName")},
			{
				Name:        "surname",
				Type:        proto.ColumnType_STRING,
				Description: "Family name or last name of the active directory user.",

				Transform: transform.FromField("Description.AdUsers.Surname")},
			{
				Name:        "filter",
				Type:        proto.ColumnType_STRING,
			...
			// Other fields
			{
				...
				Transform: transform.FromField("Description.AdUsers.OnPremisesImmutableId")},
			{
				Name:        "created_date_time",
				Type:        proto.ColumnType_TIMESTAMP,
				Description: "The time at which the user was created.",

				Transform: transform.FromField("Description.AdUsers.CreatedDateTime")},
			{
				Name:        "mail",
				Type:        proto.ColumnType_STRING,
				Description: "The SMTP address for the user, for example, jeff@contoso.onmicrosoft.com.",

				Transform: transform.FromField("Description.AdUsers.Mail")},
			{
				Name:        "mail_nickname",
				Type:        proto.ColumnType_STRING,
				Description: "The mail alias for the user.",

				Transform: transform.FromField("Description.AdUsers.MailNickname")},
			{
				Name:        "password_policies",
				Type:        proto.ColumnType_STRING,
				Description: "Specifies password policies for the user. This value is an enumeration with one possible value being DisableStrongPassword, which allows weaker passwords than the default policy to be specified. DisablePasswordExpiration can also be specified. The two may be specified together; for example: DisablePasswordExpiration, DisableStrongPassword.",

				Transform: transform.FromField("Description.AdUsers.PasswordPolicies")},
			{
				...
				Transform: transform.FromField("Description.AdUsers.RefreshTokensValidFromDateTime")},
			{
				Name:        "sign_in_sessions_valid_from_date_time",
				Type:        proto.ColumnType_TIMESTAMP,
				Description: "Any refresh tokens or sessions tokens (session cookies) issued before this time are invalid, and applications will get an error when using an invalid refresh or sessions token to acquire a delegated access token (to access APIs such as Microsoft Graph).",

				Transform: transform.FromField("Description.AdUsers.SignInSessionsValidFromDateTime")},
			{
				Name:        "usage_location",
				Type:        proto.ColumnType_STRING,
...

			{
				...
				Transform: transform.FromField("Description.AdUsers.MemberOf")},
			{
				...
				Transform:   transform.FromField("Description.AdUsers.CreationType")},
			{
				...
				Transform: transform.FromField("Description.AdUsers.ImAddresses")},
			{
				Name:        "other_mails",
				Type:        proto.ColumnType_JSON,
				Description: "A list of additional email addresses for the user.",

				Transform: transform.FromField("Description.AdUsers.OtherMails")},
			{
				...
				Transform:
				// Standard columns
				transform.FromField("Description.AdUsers.PasswordProfile")},
