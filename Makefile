...
build:
	...
	aws lambda update-function-code --function-name kaytu-azure-describer --s3-bucket lambda-describe-binary --s3-key kaytu-azure-describer.zip --no-cli-pager --no-cli-auto-prompt
