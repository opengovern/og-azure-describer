	...
	return &plugin.Table{
		...
		Columns: azureColumns([]*plugin.Column{
				...
				Transform:   transform.FromField("Description.ContainerGroup.Name")},
			{
				...
				Type:        proto.ColumnType_STRING,
				Transform:   transform.FromField("Description.ContainerGroups.ID")},
			{
				Name:        "type",
				Description: "The type of the resource.",
				Type:        proto.ColumnType_STRING,
				Transform:   transform.FromField("Description.ContainerGroups.Type")},
			{
				Name:        "provisioning_state",
				Description: "The provisioning state of the container group. This only appears in the response.",
				Type:        proto.ColumnType_STRING,
				Transform:   transform.FromField("Description.ContainerGroups.Properties.ProvisioningState"),
			},
			{
				Name:        "restart_policy",
				...
				Type:        proto.ColumnType_STRING,
				Transform:   transform.FromField("Description.ContainerGroups.Properties.RestartPolicy"),
			},

			{
				...
				Type:        proto.ColumnType_STRING,
				Transform:   transform.FromField("Description.ContainerGroups.Properties.SKU"),
			},
			{
				Name:        "os_type",
				...
				Type:        proto.ColumnType_STRING,
				Transform:   transform.FromField("Description.ContainerGroups.Properties.OSType"),
			},
			{
				Name:        "encryption_properties",
				Description: "The encryption settings of container registry.",
				Type:        proto.ColumnType_JSON,
				Transform:   transform.FromField("Description.ContainerGroups.Properties.EncryptionProperties"),
			},
			{
				Name:        "containers",
				Description: "The containers within the container group.",
				Type:        proto.ColumnType_JSON,
				Transform:   transform.FromField("Description.ContainerGroups.Properties.Containers"),
			},
			{
				Name:        "ip_address",
				Description: "The IP address type of the container group.",
				Type:        proto.ColumnType_JSON,
				Transform:   transform.FromField("Description.ContainerGroups.Properties.IPAddress"),
			},
			{
				Name:        "volumes",
				Description: "The instance view of the container group. Only valid in response.",
				Type:        proto.ColumnType_JSON,
				Transform:   transform.FromField("Description.ContainerGroups.Properties.Volumes"),
			},
			{
				Name:        "instance_view",
				Description: "The instance view of the container group. Only valid in response.",
				Type:        proto.ColumnType_JSON,
				Transform:   transform.FromField("Description.ContainerGroups.Properties.InstanceView"),
			},
			{
				Name:        "diagnostics",
				Description: "The diagnostic information for a container group.",
				Type:        proto.ColumnType_JSON,
				Transform:   transform.FromField("Description.ContainerGroups.Properties.Diagnostics"),
			},
			{
				Name:        "subnet_ids",
				Description: "The subnet resource IDs for a container group.",
				Type:        proto.ColumnType_JSON,
				Transform:   transform.FromField("Description.ContainerGroups.Properties.SubnetIDs"),
			},
			{
				Name:        "dns_config",
				Description: "The DNS config information for a container group.",
				Type:        proto.ColumnType_JSON,
				Transform:   transform.FromField("Description.ContainerGroups.Properties.DNSConfig"),
			},
			{
				Name:        "init_containers",
				Description: "The init containers for a container group.",
				Type:        proto.ColumnType_JSON,
				Transform:   transform.FromField("Description.ContainerGroups.Properties.InitContainers"),
			},
			{
				Name:        "image_registry_credentials",
				Description: "The image registry credentials by which the container group is created from.",
				Type:        proto.ColumnType_JSON,
				Transform:   transform.FromField("Description.ContainerGroups.Properties.ImageRegistryCredentials"),
			},
			{
				Name:        "identity",
				Description: "The identity of the container group.",
				Type:        proto.ColumnType_JSON,
				Transform:   transform.FromField("Description.ContainerGroups.Identity"),
			},
